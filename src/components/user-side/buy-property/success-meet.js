...
const SuccessMeet = () => {
  return (
    <div className="page-height relative flex-center p-4 pt-10 sm:pt-5">
      <div className="max-w-[60rem] w-full m-auto h-full flex flex-col gap-[1.9rem]">
        <div>
          <h1 className="opacity-90 text-5xl font-regular text-center text-accent-black lg:text-4xl md:text-3xl sm:text-2xl xs:text-xl mb-[40px]">
            Your meeting has been set for
          </h1>
          <p className="text-3xl font-bold text-center text-accent-black mt-2 lg:text-2xl md:text-xl sm:text-lg xs:text-base">
            11-12 AM, 1 January
          </p>
          <p className="text-lg text-center font-medium text-accent-black opacity-70 mt-1">
            ( ASIA/ KARACHI TIME )
          </p>
          <p className="opacity-70 text-xl text-center text-accent-black mt-4 font-medium uppercase lg:text-lg md:text-base sm:text-sm xs:text-xs">
            AT MEHRAZ OFFICE, LOCATED AT MIA PLAZA, GULBERG, LAHORE.
          </p>
          <p className="opacity-60 text-2xl font-bold text-center uppercase text-accent-black mt-2 lg:text-xl md:text-lg sm:text-base xs:text-sm">
            OUR AGENT WILL CHECK YOUR REQUIREMENT AND CONTACT YOU
          </p>
        </div>

        <div className="relative w-full h-[2px] bg-accent-black opacity-20" />
        <div
        ...
        <div className="m-auto">
          <Image
            src={teamleadImages.brand_logo_success}
            alt="logo"
