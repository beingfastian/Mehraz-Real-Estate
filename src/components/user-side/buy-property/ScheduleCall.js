...
const timeSlots = ["11-12 AM", "11-12 AM", "11-12 AM", "11-12 AM"];

const ScheduleCall = ({ setStep }) => {
  ...
  return (
    <div className="bg-[#f8f8f8] flex flex-grow h-full absolute top-0 left-0 w-full overflow-y-hidden">
      ...
      <div className="min-h-full min-w-full px-4 py-10 mt-20">
        ...
        <hr
          className="border-gray-300 mx-auto mb-10"
          style={{ width: "500px" }}
        />
        ...
        <hr
          className="border-gray-300 mx-auto my-10"
          style={{ width: "500px" }}
        />
