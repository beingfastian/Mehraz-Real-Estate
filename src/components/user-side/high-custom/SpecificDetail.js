    ...
    <section className="px-4 py-6 max-w-7xl mx-auto">
      <div className="flex flex-col">
        ...
        <div className="flex items-center gap-4 mb-4">
          <Backbutton />
          <h1 className="text-lg sm:text-xl md:text-2xl font-semibold uppercase">
            TELL US YOUR LAND REQUIREMENTS AND WE’LL TAKE IT FROM THERE
          </h1>
        </div>
        ...
        {/* Final Divider */}
        <div className="w-full border-t border-black mt-10 mb-6" />
        ...
        <div className="flex justify-center items-center gap-10 mb-6">
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="radio"
              name="meeting"
              checked={meetingType === "oncall"}
              onChange={() => setMeetingType("oncall")}
            />
            <span className="uppercase font-semibold">On-call Meeting</span>
          </label>
          <label className="flex items-center gap-2 cursor-pointer">
            <input
              type="radio"
            ...
            />
            <span className="uppercase font-semibold">Physical Meeting</span>
          </label>
        </div>
