...
const staticMessages = [
    ...
    },
    {
        ...
        senderId: "user123",
        senderName: "John Doe",
        text: "Sure, please go ahead. I'm here to help you with any questions you might have about your order.",
        timestamp: "10:02 AM",
        type: "text",
        status: "delivered",
    },
    {
        ...
        senderId: "admin",
        senderName: "You",
        text: "Thanks! When will my order be shipped?",
        timestamp: "10:03 AM",
        type: "text",
        status: "read",
    },
    {
        ...
        senderId: "user123",
        senderName: "John Doe",
        text: "Let me check that for you right away. Your order should be shipped within 2-3 business days.",
        timestamp: "10:04 AM",
        type: "text",
        status: "delivered",
    },
    {
        ...
        senderId: "admin",
        senderName: "You",
        text: "Perfect! That's exactly what I needed to know. Thank you so much! 😊",
        timestamp: "10:05 AM",
        type: "text",
        status: "sent",
    },
...
export default function MiddlePane({ selectedChat, currentUser, onToggleInfoPane, onToggleLeftPane, isMobile, showToast }) {
    ...
    useEffect(() => {
        ...
        const fetchMessages = async () => {
            try {
                ...
                const unsubscribe = onSnapshot(messagesQuery, (snapshot) => {
                    ...
                    snapshot.forEach((doc) => {
                        ...
                        messagesData.push({
                            ...
                            timestamp: messageData.timestamp ? new Date(messageData.timestamp.toDate()).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) : "Unknown",
                    ...
                    if (messagesData.length > 0) {
                        ...
                        console.log("No messages found in Firebase, using static data")
                        setMessages(staticMessages)
                    }
                    setLoading(false)
                }, (error) => {
                    ...
                    setLoading(false)
                    showToast("Failed to load messages. Using demo data.", "error")
                    setMessages(staticMessages)
                })
                ...
                setLoading(false)
                showToast("Failed to connect to message service. Using demo data.", "error")
                setMessages(staticMessages)
            }
        }
                ...
                <div className="flex items-center">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500">
                            {selectedChat.online ? "online" : selectedChat.lastSeen ? `last seen ${selectedChat.lastSeen}` : "offline"}
                        </p>
                    </div>
                </div>
                    ...
                    <div className="space-y-2 max-w-4xl mx-auto">
                        {messages.map((msg) => (
                            <div key={msg.id} className={`flex ${msg.senderId === currentUserId ? "justify-end" : "justify-start"}`}>
                                <div
                                    className={`max-w-xs lg:max-w-md xl:max-w-lg px-3 py-2 rounded-lg shadow-sm ${msg.senderId === currentUserId
                                ...
                                >
                                    ...
                                    <div
                                        className={`flex items-center justify-end mt-1 space-x-1 ${msg.senderId === currentUserId ? "text-green-100" : "text-gray-500"
                                            }`}
                                    >
